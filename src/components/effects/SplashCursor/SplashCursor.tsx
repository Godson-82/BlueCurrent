/* Vendored React Bits port (DavidHDev/react-bits) — inherits upstream lint conventions. */
/* eslint-disable */
'use client';
...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    let _ext: ReturnType<typeof getWebGLContext>['ext'] | null = null;
    try {
  ...
  return (
    <div
      style={{
        ...
        top: 0,
        left: 0,
        zIndex: 1, // background layer: behind content (main z-2, nav z-50), above aurora (z-0)
        pointerEvents: 'none',
        width: '100%',
        height: '100%'
      }}
